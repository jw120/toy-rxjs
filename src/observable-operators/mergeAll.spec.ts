...
// const toyA: ToyRx.Observer<number> = ToyRx.Observable.interval(100)
//   .map((x: number): string => 'A' + x).take(5);
// const toyB: ToyRx.Observer<number> = ToyRx.Observable.interval(100)
//   .map((x: number): string => 'A' + x).take(5);
...
// describeObsAsync('mergeAll operator (sync of async)',  'should work',
//   toy1.mergeAll(),
//   ref1.mergeAll(),
...
// describeObsAsync('mergeAll operator (async of async)',  'should work',
//   toy2.mergeAll(),
//   ref2.mergeAll(),
